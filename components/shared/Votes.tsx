// used an onClick component here in votes
"use client";
...
interface Props {
  ...
  hasSaved?: boolean;
  // we will have this saved option only in the question and not in the answer, hence we make it optional
}
...
const Voting = ({
  ...
  const handleSave = async () => {
    await toggleSaveQuestion({
      ...
      // show a toast
      return toast({
        title: `Question is ${!hasSaved ? 'Saved into' : 'Removed from'} your collection`,
  ...
  const handleVote = async (action: string) => {
    if (!userId) {
      return toast({
        title: 'Please Log In',
        description: 'You need to be logged in to continue this action!'
      })
    }
